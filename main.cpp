...
//  © 2019 Tramme Inc.
//
//  Created by William Jacky on 2018/11/22.
...
int main()                  //  主函数体
{
    ...
    switch (e) {
        ...
        case 4:
            ...
            break;
        case 5:
            cout << "\033[01;30;47m 除法保留十位小数，此计算器纯粹用了学习制作C++程序，并无商业用途！未经作者允许，不可商用或者公开使用并不声明著作权！！！一经发现，后果自负！！！ \033[0m" << endl;
...
void func(int n)
{
    ...
    int result;
    double num;
    cout << endl << endl << "版本：0.0.1.3" << endl;
    cout << "请选择你需要的计算方式" << endl;
    cout << "***********************" << endl;
    cout << "*    1. 加法           *" << endl;
    cout << "*    2. 减法           *" << endl;
